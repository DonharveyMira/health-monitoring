...
def readserial():
    #t1 = continuous_threading.PausableThread(0.5)
    global val1
    ...
    time.sleep(0.5)
t1 = continuous_threading.PausableThread(0.5, readserial)
    
btnSensor = Button(root, text="Sensor", command=readserial, 
                      bg="#497687", fg="#ffffff", state='disabled')
btnSensor.config(font=("Microsoft JhengHei", 11),cursor="hand2")
btnSensor.place(relx=0.4, rely=0.91, anchor=CENTER)
...
pr_entry = Entry(physExam_panel, textvariable= bpm, font=("Microsoft JhengHei", 11), fg="#497687", state='disabled')
...
bt_entry = Entry(physExam_panel, textvariable=temp, font=("Microsoft JhengHei", 11), fg="#497687", state='disabled')
